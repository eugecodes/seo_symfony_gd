                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo Yii::$app->user->identity->userProfile->getAvatar() ?: Yii::getAlias('@backendUrl').'/img/anonymous.jpg' ?>" class="user-image">
                                <span><?php echo Yii::$app->user->identity->username ?> <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header light-blue">
                                    <img src="<?php echo Yii::$app->user->identity->userProfile->getAvatar() ?: Yii::getAlias('@backendUrl').'/img/anonymous.jpg' ?>" class="img-circle" alt="User Image" />
                                    <p>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="<?php echo Yii::$app->user->identity->userProfile->getAvatar() ?: Yii::getAlias('@backendUrl').'/img/anonymous.jpg' ?>" class="img-circle" />
                    </div>
                    ...
                    'items'=>[
                      /*  [
                       ...
                       /* [
                        ...
                        [
                            'label'=>Yii::t('backend', 'Posicionadas'),
                            'icon'=>'<i class="fa fa-search-plus"></i>',
                            'url'=>['/posicionadas/index'],
                            'visible'=>Yii::$app->user->can('administrator')
                        ],
                        [
                            'label'=>Yii::t('backend', 'Sugeridas'),
                            'icon'=>'<i class="fa fa-paper-plane"></i>',
                            'url'=>['/sugeridas/index'],
                            'visible'=>Yii::$app->user->can('administrator')
                        ],
                        [
                            'label'=>Yii::t('backend', 'Tráfico'),
                            'icon'=>'<i class="fa fa-crosshairs"></i>',
                            'url'=>['/trafico/index'],
                            'visible'=>Yii::$app->user->can('administrator')
                        ],
                        [
                            'label'=>Yii::t('backend', 'Orgánicas'),
                            'icon'=>'<i class="fa fa-star"></i>',
                            'url'=>['/organicas/index'],
                            'visible'=>Yii::$app->user->can('administrator')
                        ],
                        [
                            'label'=>Yii::t('backend', 'Informes'),
                            'icon'=>'<i class="fa fa-newspaper-o"></i>',
                            'url'=>['/informes/index'],
                            'visible'=>Yii::$app->user->can('administrator')
                        ],
                        [
                            'label'=>Yii::t('backend', 'Reportes Enviados'),
                            'icon'=>'<i class="fa fa-mail-reply"></i>',
                            'url'=>['/emails/index'],
                            'visible'=>Yii::$app->user->can('administrator')
                        ],
                        /*[
